...
- videos：今天可以拍的 2–4 条，恰好 1 条 primary 为 true（首选）。每条：
  ...
  Park 优化的是前 1 分钟的留存和收藏评论，不是完播率。三点是整条内容的骨架，顺序是认知反差 → 痛点具象 → 交付可行性：hook 是一句泛话题的认知冲突（不是主线摘要、不摆结果），第一分钟内很快落到痛点让人共鸣；交付不必放进第一分钟，通常在结尾。
  primary 必须给三点总分最高的一条；三点里有一点只有 1 分的，不要当首选；总分相同时选认知反差高的。
