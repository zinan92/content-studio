...
1. **开头 = 认知反差。** 第一句是一句泛话题的反常识暴论，让所有人都觉得跟自己搭点边。不寒暄、不铺垫、不自我介绍，也不要在这里摆结果。写成「大多数人以为……，其实……」这类冲突，后半句要有素材支撑。
2. **中间 = 痛点具象。** 越聊越具体，落到具体的人、场景和损失，让想跟 Park 学的人觉得「这说的就是我」。这一段要有认知、有深度，不能停在情绪。
3. **结尾 = 交付可行性。** 真实结果，或者观众能迈出的第一步。素材里没有结果，就在这一条写「需要补素材：……」，不要编。
