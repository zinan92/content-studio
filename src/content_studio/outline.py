...
2. 每一条都要为主线服务：假设删掉这一条主线会不会明显变弱？不会就不要这一条。
3. Park 用三点判断一条内容值不值得拍，提纲要让三点都落在具体的句子上：
   - 痛点具象度：开头点出具体的人、场景和损失，让想跟 Park 学的人一听就认出「说的是我」；
   - 认知反差度：至少一条写成「大多数人以为……，其实……」，而且后半句有素材支撑；
   - 交付可行性：至少一条是真实结果或观众能迈出的第一步。素材里没有结果，就在这一条写「需要补素材：……」，不要编。{adjust_block}
